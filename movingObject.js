(function(root) {
  ...
  MovingObject.prototype.move = function(elapsedSeconds) {
    this.rotation += this.rotationSpeed;
    this.centerX += Math.cos(this.angle) * this.vel * elapsedSeconds;
    this.centerY += Math.sin(this.angle) * this.vel * elapsedSeconds;
  ...
  MovingObject.prototype.isCollidedWith = function(otherObject) {
    if (this.isInBounds(otherObject)) {
      ...
      return MovingObject.isWithin(poly, coords) || MovingObject.isWithin(coords, poly);
    } else {
      return false;
    }
  };
